...
export default ManageAccount // for this i want only two chance user should get to edit the email when user click inside email give mui pop up like you have two chances to edit also check valid email while editing and also suppose i change my mail as datta@dmail.com to datta12@dmail.com then then if second time i come and clikc in input give like 1 attempt left and also sender can be able to send the me emails at both mails at datta@dmail.com and datta12@dmail.com and also when email changes and attempt over then below that email field give msg like when next time editible and also if i updated the emails then old emails should not be gone which is present at datta@dmail.com becuase both user is same also profile pic should not be  gone because we just update the email